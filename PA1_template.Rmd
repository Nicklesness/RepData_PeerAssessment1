...
Firstly we will make a new dataframe which contains data with mean steps per each interval
...
No difference in median df1(with NA) and median df2(without NA).
Added some values to 5-6 intervals which makes no sense
**
